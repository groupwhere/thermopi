...
def vp_start_gui():
    ...
    #thermogui_support.set_Tk_var()
    top = thermoGUI(root)
    #thermogui_support.init(root, top)
    root.resizable(0,0)
...
def create_thermoGUI(root, *args, **kwargs):
    ...
    #thermogui_support.set_Tk_var()
    top = thermoGUI (w)
    #thermogui_support.init(w, top, *args, **kwargs)
    return (w, top)
...
#        logo = PhotoImage(file='images/thermopi.png')
#        self.logo = Label(self.mainframe)
#        self.logo.place(relx=0.01, rely=0.01, height=81, width=81)
#        self.logo.configure(image=logo)

        self.currentl = Label(self.mainframe)
        self.currentl.place(relx=0.13, rely=0.06, height=30, width=87)
...
temp''')
        ...
        self.humidityl.place(relx=0.52, rely=0.06, height=30, width=117)
...
humidity''')
        ...
        self.current.place(relx=0.31, rely=0.03, relheight=0.16, relwidth=0.16)
        ...
        #self.current.configure(font="TkFixedFont")
        ...
        self.humidity.configure(font="TkFixedFont")
        ...
        self.sys_status.place(relx=0.14, rely=0.2, height=26, width=104)
        ...
        self.goButton.place(relx=0.78, rely=0.28, height=62, width=68)
        ...
        self.timel.configure(font=self.font12)
        ...
        self.slabel = Label(self.timeset,text='Start', font=self.font12, bg='black', fg='white')
        self.elabel = Label(self.timeset,text='End', font=self.font12, bg='black', fg='white')
        ...
        self.shourl.place(relx=0.30, rely=0.25, height=15, width=75)
        self.sminl.place(relx=0.50, rely=0.25, height=15, width=75)
        self.elabel.place(relx=0.05, rely=0.35, height=15, width=75)
        self.ehourl.place(relx=0.30, rely=0.35, height=15, width=75)
        self.eminl.place(relx=0.50, rely=0.35, height=15, width=75)
        ...
        self.templ = Label(self.tempset)
        self.templ.place(relx=0.05, rely=0.1, height=25, width=160)
        self.templ.configure(activebackground="black")
        self.templ.configure(activeforeground="white")
        self.templ.configure(activeforeground="white")
        self.templ.configure(background="black")
        self.templ.configure(disabledforeground="white")
        self.templ.configure(font=self.font12)
        self.templ.configure(foreground="white")
        self.templ.configure(highlightbackground="black")
        self.templ.configure(highlightcolor="white")
        self.templ.configure(text='Adjust temps for:')
    ...
    def tempAdj(self,name,lowtemp=0,hightemp=0,lowonly=False,highonly=False):
        ...
        if lowonly:
            ...
            self.templ.configure(text='Adjust low temp for:')
        elif highonly:
            ...
            self.templ.configure(text='Adjust high temp for:')
        else:
            self.low_btn.configure(text='Low Temp')
            self.high_btn.configure(text='High Temp')
            self.templ.configure(text='Adjust temps for:')
