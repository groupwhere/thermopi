...
* GUI should be working to configure the schedule via the schedule class.  However, this needs work to ensure that the schedule is disabled for as long as you want it to be.  Currently, switching the unit on when the schedule is disabled re-enables the schedule.  Work in progress 02 May 2016
